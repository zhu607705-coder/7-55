...
const VALIDATORS = Object.freeze({
  ...
  canteenChaseModel: Object.freeze({ area: "chapter-3", script: "verify:canteen-chase-model", risk: "90s route, physical rider contacts and bounded model geometry" }),
  ...
  theaterLobby: Object.freeze({ area: "chapter-3", script: "theater:validate-lobby", risk: "physical charging proximity, phone exclusion and ticket transaction" }),
