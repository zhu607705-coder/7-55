...
## 2026-07-23 校园全景接缝、人物动画与食堂入口收口

- 全景图收口：校园底图保持 `11744×1084`，东段原 `x=8939 / 10133` 两处接缝替换为一段连续生成的校园条带；天空、树线、湖岸、水面、人行道、路缘、车道和标线连续。对 `x=1300 / 2643 / 3944 / 5700 / 7079 / 8939 / 10133` 的原尺寸竖向裁片逐带目视检查，道路高度与建筑边缘均未出现断层。底图 SHA-256 为 `6dc300c8812ca95340824a08649478443e37b5b4a1789e0b64bb86261d032741`。
- 通行区收口：按最终底图原像素坐标重建 `4px` 网格遮罩；前景道路与人行道从 `y=864` 连续开放，排水口、标线、阴影和接缝不再生成空气墙。食堂、三处建筑入口、四条斜向公共通路及图书馆 L 形铺装通路采用明确几何区域，草地、花坛、水面、栅栏和前景设施保持阻挡。
- 人物资源：共享 RPG 人物改为上、下、侧向各 `4` 帧、共 `12` 张独立 `96×128` 像素帧；室内保持原显示尺寸，校园使用 `2×` 基线及前景最高 `1.5×` 的统一纵深曲线，碰撞盒继续使用固定世界尺寸。
