...
import { ChapterThreePhoneInterludeController } from "./ChapterThreePhoneInterludeController";
...
export const kit = {
  ...
  chapterThreeInterlude: new ChapterThreePhoneInterludeController(gameStore, eventBus),
