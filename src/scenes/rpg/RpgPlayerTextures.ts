...
// 96px source frames keep the former world-space presentation only when this
// multiplier stays at 1.5: 96 × 0.65 × 1.5 = 93.6px at the far campus plane,
// matching the accepted 48 × 1.3 × 1.5 appearance while retaining the fixed
// foot collision box.
export const RPG_CAMPUS_PLAYER_BASE_MULTIPLIER = 1.5;
