...
export const QIZHEN_LAKE_ZONES: Readonly<Record<QizhenLakeZoneId, QizhenLakeZoneDefinition>> = {
  dock: {
    ...
    onFootCollisions: [
      ...
      { id: "pier_west_water", left: 520, top: 555, right: 630, bottom: 650 },
      { id: "pier_east_water", left: 790, top: 430, right: 1672, bottom: 650 },
      { id: "southeast_water", left: 1080, top: 650, right: 1672, bottom: 941 },
      { id: "south_willow_water", left: 790, top: 600, right: 1100, bottom: 941 },
...
export const QIZHEN_LAKE_TARGETS: readonly QizhenLakeInteractionTarget[] = [
  ...
  target({ id: "qizhen_dock_board", label: "小码头登船边", x: 710, y: 650, width: 80, height: 120, stand: { x: 650, y: 690 }, kind: "board", zone: "dock", vehicle: "on_foot", proximity: 64 }),
