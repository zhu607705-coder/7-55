export const GAME_SAVE_KEY = "seven_fifty_five_state";
export const GAME_SAVE_BACKUP_KEY = "seven_fifty_five_state_backup";
export const BIKE_SAVE_KEY = "seven_fifty_five_bike_arcade_state";
