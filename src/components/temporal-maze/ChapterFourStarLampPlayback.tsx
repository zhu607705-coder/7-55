...
interface ChapterFourStarLampPlaybackProps {
  sessionId: string;
...
export function ChapterFourStarLampPlayback({
  sessionId,
  feedback = null,
  onComplete
}: ChapterFourStarLampPlaybackProps) {
  ...
  return (
    <section
      ref={rootRef}
      className={`chapter4-star-lamp-playback is-${rendererMode}`}
      role="dialog"
      aria-modal="true"
      ...
      style={style}
    >
      <div className="chapter4-star-lamp-playback__fallback" aria-hidden="true">
        <div className="chapter4-star-lamp-playback__fallback-stars is-far" />
        <div className="chapter4-star-lamp-playback__fallback-stars is-middle" />
        <div className="chapter4-star-lamp-playback__fallback-stars is-near" />
      </div>
      <canvas
        ref={canvasRef}
        className="chapter4-star-lamp-playback__canvas"
        role="img"
      ...
      />
      <div className="chapter4-star-lamp-playback__artwork" aria-hidden="true">
        <img className="chapter4-star-lamp-playback__layer is-dark" src={lampDarkUrl} alt="" />
        <img className="chapter4-star-lamp-playback__layer is-outline" src={lampOutlineUrl} alt="" />
        <img className="chapter4-star-lamp-playback__layer is-leds" src={lampLedsUrl} alt="" />
        <img className="chapter4-star-lamp-playback__layer is-core" src={lampCoreUrl} alt="" />
        <img className="chapter4-star-lamp-playback__layer is-glow" src={lampGlowUrl} alt="" />
        <div className="chapter4-star-lamp-playback__flare" />
      </div>
      <div className="chapter4-star-lamp-playback__vignette" aria-hidden="true" />
      <div className="chapter4-star-lamp-playback__blackout" aria-hidden="true" />
      <footer className="chapter4-star-lamp-playback__caption">
        <strong>07:55</strong>
        <span>灿若星辰</span>
        {feedback ? <small role="status">{feedback}</small> : null}
      </footer>
      <span className="chapter4-star-lamp-playback__sr-status" aria-live="polite">
